...
!  Read initial parameters.
       ...
       !FYCR Read in the parameters for the neutrino visibility function
       P%G_nu_eff = Ini_Read_Double('G_nu_eff')
       P%interacting_fraction = Ini_Read_Double('interacting_fraction')
